        ...
        <div class="py-12 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <x-partials.card style="padding: 50px;"> 
                    ...
                    <form method="GET" action="{{ url('/diagram_pesanan') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mb-8 mt-8">
                        <div class="bg-slate p-6 rounded shadow flex items-center justify-between text-white">
                            ...
                            <div class="text-right">
                                <h5 class="text-lg">Total pemasukan dari {{ $start_date }} sampai {{ $end_date }}</h5>
                                <div class="text-2xl font-semibold">{{ IDR($total_pemasukan) }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <th style="padding-top: 50px;">Chart Pemasukan</th>
                        </tr>
                        <tr>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <th style="padding-top: 50px;">Chart Produk Terlaris</th>
                        </tr>
                        <tr>
                            <td style="border-radius: 10px 0 0 10px;">
                                <div class="container">
