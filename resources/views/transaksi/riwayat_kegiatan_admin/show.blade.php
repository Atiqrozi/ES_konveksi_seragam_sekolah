    ...
    <div class="bg">
        <div class="py-12 bg-grey min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <x-partials.card>
                    <x-slot name="title">
                        <a href="{{ route('riwayat_kegiatan_admin.index') }}" class="mr-4"
                    ...
                    <div class="mt-4 px-4 row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <span>{{ optional($riwayat_kegiatan_admin->pekerjaan)->nama_pekerjaan ?? '-'}}</span>
                            </div>
                    ...
                    <div class="mt-10">
                        <a href="{{ route('riwayat_kegiatan_admin.index') }}" class="button">
