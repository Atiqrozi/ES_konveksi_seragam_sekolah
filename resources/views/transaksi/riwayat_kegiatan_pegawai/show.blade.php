    ...
    <div class="bg">
        <div class="py-12 bg-grey min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <x-partials.card>
                    <x-slot name="title">
                        <a href="{{ route('riwayat_kegiatan_pegawai.index') }}" class="mr-4"
                    ...
                    <div class="mt-4 px-4 row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <span>{{ optional($riwayat_kegiatan_pegawai->pekerjaan)->nama_pekerjaan ?? '-'}}</span>
                            </div>
                    ...
                    <div class="mt-10">
                        <a href="{{ route('riwayat_kegiatan_pegawai.index') }}" class="button">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach($kegiatans as $key => $kegiatan)
                            <tr>
                                <td>{{ $kegiatan->pekerjaan->nama_pekerjaan }}</td>
                                <td>{{ $kegiatan->jumlah_kegiatan }}</td>
                                <td>{{ IDR($kegiatan->pekerjaan->gaji_per_pekerjaan) }}</td>
                                <td>{{ IDR($kegiatan->jumlah_kegiatan * $kegiatan->pekerjaan->gaji_per_pekerjaan) }}</td>
