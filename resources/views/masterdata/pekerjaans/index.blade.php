                    ...
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-left" style="max-width: 400px" data-label="Nama pekerjaan">
                                    {{ $pekerjaan->nama_pekerjaan ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-left" style="min-width: 200px" data-label="Gaji Per pekerjaan">
                                    {{ IDR($pekerjaan->gaji_per_pekerjaan) ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-left" style="max-width: 400px" data-label="Deskripsi">
