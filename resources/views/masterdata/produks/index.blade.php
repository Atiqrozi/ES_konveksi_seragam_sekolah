                            ...
                            <tr >
                                ...
                                @foreach($columns as $field => $label)
                                    <th class="px-4 py-3 text-left">
                                        <a href="{{ route('produks.index', array_merge(request()->query(), ['sort_by' => $field, 'sort_direction' => ($sortBy === $field && $sortDirection === 'asc') ? 'desc' : 'asc'])) }}">
                                            {{ $label }}
                                            @if($sortBy === $field)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-left">
                                    @if($produk->foto_sampul)
                                        <img src="{{ Storage::url($produk->foto_sampul) }}" alt="Foto Sampul" class="w-16 h-16 object-cover">
                                    @else
                                        -
                                    @endif
                                </td>
