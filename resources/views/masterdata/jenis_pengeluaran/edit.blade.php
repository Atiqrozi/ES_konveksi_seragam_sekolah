    ...
    <div class="bg">
        <style>
            @media (max-width: 768px) {
                ...
                .mt-4 input[type="text"], .mt-4 input[type="email"], .mt-4 input[type="number"], .mt-4 input[type="date"], .mt-4 input[type="password"], .mt-4 textarea, .mt-4 select {
                    width: 100% !important; padding: 0.75rem !important; font-size: 16px !important; border: 1px solid #d1d5db !important; border-radius: 0.375rem !important; box-sizing: border-box !important;
                }
        ...
        <div class="py-12 bg-grey min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <x-partials.card>
                    ...
                    <x-form
                        method="PUT"
                        action="{{ route('jenis_pengeluaran.update', $jenis_pengeluaran) }}"
                        has-files
                        class="mt-4"
                    >
                        ...
                        <div class="mt-10">
                            ...
                            <a
                                href="{{ route('jenis_pengeluaran.create') }}"
                                class="button"
                            >
