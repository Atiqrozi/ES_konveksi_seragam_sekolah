                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-slate p-6 rounded shadow flex items-center justify-between text-white">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-2xl font-semibold">{{ $total_admin }}</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate p-6 rounded shadow flex items-center justify-between text-white">
                        ...
                        <div class="text-right">
                            <h5 class="text-lg">Admin Laki-Laki</h5>
                            <div class="text-2xl font-semibold">{{ $admin_laki }}</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate p-6 rounded shadow flex items-center justify-between text-white">
                        ...
                        <div class="text-right">
                            <h5 class="text-lg">Admin Perempuan</h5>
                            <div class="text-2xl font-semibold">{{ $admin_perempuan }}</div>
                        </div>
                    </div>
                </div>
