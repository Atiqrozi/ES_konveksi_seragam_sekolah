<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Ubah Posisi Lowongan
        </h2>
    </x-slot>

    <div class="bg">
        <style>
            /* Mobile-specific layout fixes for posisi lowongan edit form (only affects <=768px) */
            @media (max-width: 768px) {
                ...
                .flex.flex-wrap > .w-full { width: 100% !important; margin-bottom: 1rem !important; }
                ...
                .mt-4 input[type="text"],
                .mt-4 input[type="email"],
                .mt-4 input[type="number"],
                .mt-4 input[type="date"],
                .mt-4 input[type="password"],
                .mt-4 textarea,
                .mt-4 select {
                    width: 100% !important;
        ...
        <div class="py-12 bg-grey min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <x-partials.card>
                    ...
                    <x-form
                        method="PUT"
                        action="{{ route('posisi_lowongan.update', $posisi_lowongan) }}"
                        has-files
                        class="mt-4"
                    >
                        @include('hiring.posisi_lowongan.form-inputs')
                        ...
                        <div class="mt-10">
                            ...
                            <a
                                href="{{ route('posisi_lowongan.create') }}"
                                class="button"
                            >
