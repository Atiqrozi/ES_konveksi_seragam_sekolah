                    ...
                    <table class="w-full max-w-full mb-4 bg-transparent">
                            ...
                            <tr>
                                @php
                                    $columns = [
                                        ...
                                        'total_gaji_yang_bisa_diajukan' => 'Gaji Tersedia',
                                        'terhitung_tanggal' => 'Terhitung Tanggal',
                                    ];
                                @endphp
                                @foreach($columns as $field => $label)
                                    <th class="px-4 py-3 text-left">
                                        <a href="{{ route('gaji_semua_pegawai.index', array_merge(request()->query(), ['sort_by' => $field, 'sort_direction' => ($sortBy === $field && $sortDirection === 'asc') ? 'desc' : 'asc'])) }}">
                                            {{ $label }}
                                            @if($sortBy === $field)
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-left" style="max-width: 400px" data-label="Gaji Tersedia">
