...
class Pelamar_Export_Excel implements FromCollection, WithHeadings, WithMapping
{
    protected $timestamp;
    protected $headings;
    ...
    {
        return Pelamar::whereIn('status', ['Diajukan', 'Belum Wawancara', 'Sudah Wawancara'])->get();
    }
